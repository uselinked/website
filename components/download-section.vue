<template>
  <section class="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-8 relative z-30 pt-24 pb-24">
    <!-- This example requires Tailwind CSS v2.0+ -->
    <div class="">
      <div class="py-16 sm:py-24">
        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800 mb-2">
            {{ this.version }}
          </span>
        <div class="lg:grid lg:grid-cols-2 lg:gap-8" id='download'>
          <h2 class="text-3xl font-extrabold text-red-900 lg:max-w-xl text-left">
          ...
          <div class="flow-root self-center mt-8 lg:mt-0">
            <div class="-mt-4 -ml-8 flex flex-wrap justify-between lg:-ml-4">
              <div class="mt-4 ml-8 flex flex-grow flex-shrink-0 justify-center lg:flex-grow-0 lg:ml-4">
                <a class='flex text-red-800 hover:text-red-500' :href='this.downloadLinks.mac'><apple-icon />&nbsp;macOS</a>
              </div>
              <div class="mt-4 ml-8 flex flex-grow flex-shrink-0 justify-center lg:flex-grow-0 lg:ml-4">
                <a class='flex text-red-800 hover:text-red-500' :href='this.downloadLinks.windows'><windows-icon />&nbsp;Windows</a>
              </div>
              <div class="mt-4 ml-8 flex flex-grow flex-shrink-0 justify-center lg:flex-grow-0 lg:ml-4">
                <a class='flex text-red-800 hover:text-red-500' :href='this.downloadLinks.linux.deb'><ubuntu-icon />&nbsp;Linux (.deb)</a>
              </div>
            </div>
          </div>
        </div>
